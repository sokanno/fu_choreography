...
params = {
    ...
    "fin_amp"    : 4.0,
    "fin_freq"   : 1.5,
    "base_height_without_person": 1.0,  # 観客がいないときの基準高さ [m]
    "auto" : 1.0,  # 自律制御モード (1.0=有効, 0.0=無効)
    
    # ========================================================
    # マニュアルモード用パラメータ（追加）
    # ========================================================
    "manual_target":   0.0,     # 0=全体、1-49=個別ID
    "manual_z":        2.7,     # 高さ指令値 [m] (0.0-2.8)
    "manual_yaw":      0.0,     # 水平角度 [deg] (0-360)
    "manual_pitch":    0.0,     # 仰角 [deg] (-60 to +60)
    "manual_r":        0.0,     # 赤成分 (0.0-1.0)
    "manual_g":        0.0,     # 緑成分 (0.0-1.0)
    "manual_b":        0.0,     # 青成分 (0.0-1.0)
    "manual_dl":       0.0,     # 移動速度 (0.0-1.0)
    "manual_send":     0.0,     # トリガー (1.0でコマンド送信実行)

    # ======================================================== 
    # シマー
    # ========================================================
    "rare_prob":     0.05,     # シマー振幅 (0.0-1.0)
    # "rare_factor":  6,      # シマーの影響度 (0.0-1.0)
    "rare_factor":  3,      # シマーの影響度 (0.0-1.0)
    # ======================================================== 
    # 回る天井
    # ========================================================
    "tilt_angle_deg": 12.0,  # 傾き角度 (0.0-10.0)
    "plane_height": 2.4,  # 平面の高さ (0.0-3.0)
        # "tilt_angle_deg": 15.0,  # 傾き角度 (0.0-10.0)
    # "plane_height": 2.0,  # 平面の高さ (0.0-3.0)
    # ======================================================== 
    # 天上天下モード
    # ========================================================
    # "min_height": 1.0,
    # "center_z": 2.15,  # 天井の中心高さ
    "min_height": 1.85, #念の為
    "center_z": 2.15,  # 天井の中心高さ
}
