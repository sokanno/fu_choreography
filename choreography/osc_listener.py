...
params = {
    ...
    "manual_r":        0.1,     # 赤成分 (0.0-1.0)
    "manual_g":        0.1,     # 緑成分 (0.0-1.0)
    "manual_b":        0.1,     # 青成分 (0.0-1.0)
    ...
    "rare_factor":  4,      # シマーの影響度 (0.0-1.0)
    # ======================================================== 
    # 回る天井
    # ========================================================
    "tilt_angle_deg": 7.5,  # 傾き角度 (0.0-10.0)
    "plane_height": 2.3,  # 平面の高さ (0.0-3.0)
    # ======================================================== 
    # 天上天下モード
    # ========================================================
    "min_height": 1.0,
