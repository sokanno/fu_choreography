...
params = {
    ...
    "fin_amp"    : 4.0,
    "fin_freq"   : 1.5,
    "base_height_without_person": 2.0,  # 観客がいないときの基準高さ [m]
    ...
    "manual_z":        1.5,     # 高さ指令値 [m] (0.0-2.8)
    "manual_yaw":      0.0,     # 水平角度 [deg] (0-360)
    "manual_pitch":    0.0,     # 仰角 [deg] (-60 to +60)
    "manual_r":        0.83,     # 赤成分 (0.0-1.0)
    "manual_g":        0.55,     # 緑成分 (0.0-1.0)
    "manual_b":        0.12,     # 青成分 (0.0-1.0)
    ...
    # 回る天井
    # ========================================================
    "tilt_angle_deg": 9.,  # 傾き角度 (0.0-10.0)
    "plane_height": 2.25,  # 平面の高さ (0.0-3.0)
    # ======================================================== 
    # 天上天下モード
    # ========================================================
    "min_height": 1.0,
