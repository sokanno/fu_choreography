...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 140.0, 893.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 895.0, 127.0, 20.0 ],
					"text" : "Pause",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 213.0, 15.0, 670.0, 22.0 ],
					"text" : "clear, append フローモード, append 天上天下モード, append 回る天井, append 鬼さんこちら, append 魚群, append シマー"
				}
